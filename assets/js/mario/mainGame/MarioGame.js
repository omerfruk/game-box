...
function MarioGame() {
  ...
  this.showInstructions = function() {
    gameUI.writeText('Kontroller: Hareket etmek icin Ok tuslarini, Kosmak icin "Shift", Ates etmek icin "ctrl"', 30, 30);
    gameUI.writeText('İp Ucu: Kosarken daha yuksege ziplayabilirisiniz', 30, 60);
  };
